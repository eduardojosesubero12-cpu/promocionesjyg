...
/* Si algo falla en tiempo de ejecución, muestra una pantalla de recuperación en vez de dejar la app en blanco */
    ...
    if (this.state.error) {
      return (
        <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#e9edf3", fontFamily: "Poppins, sans-serif", padding: 24 }}>
          <div style={{ background: "#fff", borderRadius: 20, padding: "36px 32px", maxWidth: 460, textAlign: "center", boxShadow: "0 24px 60px -18px rgba(16,65,114,.35)" }}>
            ...
            <h2 style={{ margin: "14px 0 6px", fontSize: 20 }}>El CRM encontró un problema</h2>
            <p style={{ color: "#4d5a6e", fontSize: 13.5, margin: 0 }}>
              Tus datos están guardados en este navegador. Reinicia la vista para continuar; si el problema persiste, restaura el último respaldo desde Configuración.
            </p>
